...
if [ -f /usr/lib/raspberrypi-sys-mods/imager_custom ]; then
   /usr/lib/raspberrypi-sys-mods/imager_custom set_wlan 'UCLab' '1fa0230a2ba7ef583b3a736245ab4bc15cc52979026e9f8f35b17239ef4e12ee' 'JP'
else
...
network={
	ssid="UCLab"
	psk=1fa0230a2ba7ef583b3a736245ab4bc15cc52979026e9f8f35b17239ef4e12ee
}
